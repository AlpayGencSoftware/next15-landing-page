    ...
    <div className={`fixed ${navBg ? "bg-white shadow-md" : "bg-transparent"} w-full transition-all duration-300 h-[12vh] z-[1000]`}>
      <div className='flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto'>
        ...
        <h1 className='text-xl md:text-2xl font-bold'>
          <span className='text-3xl text-blue-500'>AAP</span>
          <span className='text-3xl text-black'>log</span>
        </h1>
        ...
        <div className='flex items-center space-x-4'>
          <button className='md:px-8 md:py-3 px-4 py-2 rounded-full bg-blue-500 text-white hover:bg-blue-600 transition-all duration-300'>
            Join Now
          </button> 
          {/* Burger menu */} 
